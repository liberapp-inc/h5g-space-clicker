    ...
    GameScene.createEnemy = function () {
        ...
        switch (createEnemy) {
            case RandomEnemy.RECT:
                var re = new RectEnemy(Game.width / 2, Game.height / 4, Game.width / 4, Game.height / 6, Util.color(0, 0, 255), 100, 1000);
            ...
            case RandomEnemy.CIRCLE:
                ...
                var cw = cr; //width
                var ch = cr; //height
                var ce = new CircleEnemy(Game.width / 2, Game.height / 4, cw, ch, cr, Util.color(0, 0, 255), 100, 1000);
