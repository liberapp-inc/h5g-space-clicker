...
var GameScene = (function (_super) {
    ...
    GameScene.createEnemy = function () {
        ...
        var rectEnemyColor = Util.color(0, 254, 0);
        var circleEnemyColor = Util.color(255, 100, 255);
        var bossColor = Util.color(255, 240, 39);
        var bossHpTextColor = Util.color(254, 0, 0);
        var enemyHP = 0;
